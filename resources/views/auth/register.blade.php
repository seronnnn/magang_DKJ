    ...
    <div class="hidden lg:flex lg:w-1/2 xl:w-5/12 bg-[#0f2942] flex-col justify-between p-12 relative overflow-hidden">
        ...
        <div class="relative z-10 space-y-6">
            ...
            <h1 class="text-4xl font-bold text-white leading-tight">
                Selamat datang<br>di Portal <span class="text-sky-400">Magang</span>
            </h1>
            <p class="text-slate-400 text-base leading-relaxed max-w-sm">
                Buat akun Anda untuk mengakses sistem informasi magang DKJ. Kelola data, pantau progres, dan nikmati kemudahan layanan digital.
            </p>

            {{-- Feature list --}}
            <ul class="space-y-3 pt-2">
                @foreach ([
                    'Akses dashboard personal sesuai peran',
                    'Pantau status magang secara real-time',
                    'Unduh laporan & dokumen digital'
                ] as $item)
                <li class="flex items-center gap-3 text-slate-300 text-sm">
                    <span class="w-5 h-5 rounded-full bg-sky-500/20 border border-sky-500/40 flex items-center justify-center flex-shrink-0">
    ...
    <div class="flex-1 flex items-center justify-center px-6 py-12 lg:px-12">
        <div class="w-full max-w-md">
                    ...
                    <div class="relative">
                        ...
                        <input
                            ...
                            class="w-full pl-10 pr-4 py-2.5 text-sm border border-slate-200 rounded-xl bg-white text-slate-800 placeholder-slate-400
                                   ...
                                   @error('name') border-red-400 focus:ring-red-400/30 focus:border-red-400 @enderror"
                        >
                    </div>
                    @error('name')
                ...
                <div>
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        ...
                        <label class="relative cursor-pointer">
                            ...
                            <div class="flex flex-col items-center gap-2 p-4 border-2 border-slate-200 rounded-xl bg-white text-center
                                        transition-all peer-checked:border-sky-500 peer-checked:bg-sky-50 hover:border-slate-300">
                                <span class="w-8 h-8 rounded-full bg-slate-100 peer-checked:bg-sky-100 flex items-center justify-center transition-colors">
                                    <svg class="w-4 h-4 text-slate-500 peer-checked:text-sky-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/>
                                    </svg>
                                </span>
                                <div>
                                    <p class="text-sm font-semibold text-slate-700">User</p>
                                    <p class="text-xs text-slate-400">Peserta magang</p>
                                </div>
                                {{-- Check badge --}}
                        ...
                        <label class="relative cursor-pointer">
                            ...
                            <div class="flex flex-col items-center gap-2 p-4 border-2 border-slate-200 rounded-xl bg-white text-center
                                        transition-all peer-checked:border-sky-500 peer-checked:bg-sky-50 hover:border-slate-300">
                                <span class="w-8 h-8 rounded-full bg-slate-100 flex items-center justify-center transition-colors">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-slate-400">Pengelola sistem</p>
                                </div>
                                <span class="absolute top-2 right-2 w-4 h-4 rounded-full bg-sky-500 hidden peer-checked:flex items-center justify-center">
                                    <svg class="w-2.5 h-2.5 text-white" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/>
            ...
            <p class="text-center text-sm text-slate-500 mt-6">
                Sudah punya akun?
                <a href="{{ route('login') }}" class="font-semibold text-sky-600 hover:text-sky-700 hover:underline transition-colors">
                    Masuk di sini
                </a>
            </p>
