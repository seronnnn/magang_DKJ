...
style="padding:4px 10px;border:1px solid #dc2626;border-radius:6px;
    ...
    {{-- *** FIX #2: Invoice checklist - scrollable, overflow:hidden removed *** --}}
...
if (btn) {
btn.disabled = true;
btn.innerHTML = '<svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/></svg> Sending…';
  }
try {
...
if (btn) {
btn.disabled = false;
btn.innerHTML = '<svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/></svg> Email';
      }
    }
  } catch (err) {
...
fb.textContent   = '⚠️ Terjadi kesalahan jaringan: ' + err.message;
fb.style.cssText = 'display:block;background:#fee2e2;border:1px solid #fca5a5;color:#991b1b;padding:12px 16px;border-radius:9px;font-size:13px;font-weight:600;margin-top:14px';
  } finally {
btn.disabled    = false;
